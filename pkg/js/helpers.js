...
function locStringBuilder(record, args) {
    ...
    precisionbuffer = (args.alt < -100000 ? -100000: args.alt > 42849672.95 ? 42849672.95: args.alt.toString()) + 'm';
    precisionbuffer += ' ' + (args.siz > 90000000 ? 90000000: args.siz < 0 ? 0 : args.siz.toString()) + 'm';
    precisionbuffer += ' ' + (args.hp  > 90000000 ? 90000000: args.hp  < 0 ? 0 : args.hp.toString()) + 'm';
    precisionbuffer += ' ' + (args.vp  > 90000000 ? 90000000: args.vp  < 0 ? 0 : args.vp.toString()) + 'm';
...
function locDMSBuilder(record, args) {
    ...
    record.localtitude = record.localtitude > 4294967295 ? 4294967295 : record.localtitude < 0 ? 0 : record.localtitude;
    // Size
